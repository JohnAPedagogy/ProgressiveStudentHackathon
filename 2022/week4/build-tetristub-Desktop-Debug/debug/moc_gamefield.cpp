...
QT_MOC_LITERAL(5, 41, 6), // "result"
QT_MOC_LITERAL(6, 48, 10) // "mapLogical"

    },
    "GameField\0boardChanged\0\0QPair<int,int>\0"
    "c\0result\0mapLogical"
};
...
void GameField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->boardChanged((*reinterpret_cast< QPair<int,int>(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->mapLogical((*reinterpret_cast< QPair<int,int>(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameField::*)(QPair<int,int> , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameField::boardChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameField::boardChanged(QPair<int,int> _t1, int _t2)
{
